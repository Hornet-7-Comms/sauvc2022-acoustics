...
// channel2sc1aADC0[6] | ADC_SC1_AIEN ; // channel number along with ISR enable
...
void setup_dma() {
  ...
  dma0->TCD->DOFF = 2; 
  dma0->TCD->DLASTSGA = -2*BUF_SIZE; // DMA_TCDn_DLASTSGA ->TCD Last Destination Address Adjustment/Scatter Gather Address Adjustment value added to the destination address at the completion of the major iteration count
